...
<div className="bigbig">
  <div className="row roow">
    ...
    <p className="title">
    You don't have to be<br /> a doctor to save lives 
            </p> 
    </div>
    ...
    <br/>
                ...
                <br />
                <label className="llabell" style={{fontFamily:"Quattrocento Sans", right: "1025px",marginLeft:"7px", fontSize: "20px"}}>last time you donate blood </label>
                <select style={{width: "160px", height: "25px", background: "#FFFFFF", borderRadius: "3px", marginLeft:"25px"}} name="City"
                required >
                  <option>less than week</option>
                  <option>less than one month</option>
                  <option>less than two months</option>
                  <option>less than three months</option>
                  <option>more than three months</option>
                </select>
                <br/>
                <label className="llabell" style={{fontFamily:"Quattrocento Sans", right: "1025px",marginLeft:"5px", fontSize: "20px"}}>Do you have any diseases?</label>
                <textarea style={{width: "300px", height: "60px", background: "#FFFFFF", borderRadius: "3px", marginLeft:"120px"}} type="text" name="comment"
                required/>
                <br/> <br/>
                <NavLink to="/NeederList">
